...
#include "HomogenizedThermalConductivity2.h"
#include "SubProblem.h"
#include "MooseMesh.h"

registerMooseObject("jvdpApp", HomogenizedThermalConductivity2);

InputParameters
HomogenizedThermalConductivity2::validParams()
{
...
HomogenizedThermalConductivity2::HomogenizedThermalConductivity2(const InputParameters & parameters)
...
void
HomogenizedThermalConductivity2::initialize()
{
  _integral_value = 0.0;
  _volume = 0.0;
}
...
void
HomogenizedThermalConductivity2::execute()
{
...
Real
HomogenizedThermalConductivity2::getValue()
{
...
void
HomogenizedThermalConductivity2::threadJoin(const UserObject & y)
{
  const HomogenizedThermalConductivity2 & pps =
      dynamic_cast<const HomogenizedThermalConductivity2 &>(y);
...
Real
HomogenizedThermalConductivity2::computeQpIntegral()
{
  Real value = 0.0;
